...
String getColorTypeString() {
	switch (colorType) {
		case COLOR_TYPE_GRAYSCALE: 				return "Grayscale"; //$NON-NLS-1$
		case COLOR_TYPE_RGB: 					return "RGB";		 //$NON-NLS-1$
		case COLOR_TYPE_PALETTE:				return "Palette"; //$NON-NLS-1$
		case COLOR_TYPE_GRAYSCALE_WITH_ALPHA:	return "Grayscale with Alpha"; //$NON-NLS-1$
		case COLOR_TYPE_RGB_WITH_ALPHA:			return "RGB with Alpha"; //$NON-NLS-1$
		default:								return "Unknown - " + colorType; //$NON-NLS-1$
	}
}

String getFilterMethodString() {
	switch (filterMethod) {
		case FILTER_NONE:		return "None"; //$NON-NLS-1$
		case FILTER_SUB:		return "Sub"; //$NON-NLS-1$
		case FILTER_UP:			return "Up"; //$NON-NLS-1$
		case FILTER_AVERAGE:	return "Average"; //$NON-NLS-1$
		case FILTER_PAETH:		return "Paeth"; //$NON-NLS-1$
...
String getInterlaceMethodString() {
	switch (interlaceMethod) {
		case INTERLACE_METHOD_NONE: 	return "Not Interlaced"; //$NON-NLS-1$
		case INTERLACE_METHOD_ADAM7:	return "Interlaced - ADAM7"; //$NON-NLS-1$
		default:				return "Unknown"; //$NON-NLS-1$
	}
}
