 ...
 * @author John
 */
public interface UploadStatusMonitor {

    void uploadStarted(UploadEvent e);

    void uploadStatusChanged(UploadEvent e);

    void uploadFinished(UploadCompleteEvent e);

    void allUploadsComplete();

    void uploadFailed(UploadEvent e);
