...
public class InfoFailedException extends ProtocolException {
    public InfoFailedException(String message) {
        super(message);
    }

    public InfoFailedException(String message, Throwable cause) {
        super(message, cause);
    }
}
