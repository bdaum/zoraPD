...
public class Messages extends NLS {
	private static final String BUNDLE_NAME = "org.scohen.juploadr.upload.messages"; //$NON-NLS-1$
	public static String BandwidthThrottlingOutputStream_write_interrupted;
	public static String HttpClientFactory_bad_uri_for_proxy;
	static {
