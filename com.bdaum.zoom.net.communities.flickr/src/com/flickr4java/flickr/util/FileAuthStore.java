...
/**
 * 
 * Implements a filesystem based storage system for Auth instances. One ".auth"
 * file is maintained per Auth instance stored.
 * 
...
public class FileAuthStore implements AuthStore {
	 ...
	 * 
	 * @see
	 * com.flickr4java.flickr.util.AuthStore#store(com.flickr4java.flickr.auth.Auth)
	 */
	...
	/*
	 * (non-Javadoc) Retrieve via flickr user id or username.
	 * 
	...
	public static void main(String[] args) throws Exception {
		FileAuthStore fas = new FileAuthStore(
