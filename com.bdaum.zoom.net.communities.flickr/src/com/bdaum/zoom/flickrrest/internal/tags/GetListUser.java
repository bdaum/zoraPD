...
package com.bdaum.zoom.flickrrest.internal.tags;
...
public class GetListUser extends FlickrMethod {
	private List<org.scohen.juploadr.app.tags.Tag> tags = new LinkedList<org.scohen.juploadr.app.tags.Tag>();
	...
	protected boolean doExecute(CommunityAccount account)
		...
		for (Tag tag : RestFlickrApi.FLICKR.getTagsInterface().getListUser(session.getSessionId()))
			tags.add(new org.scohen.juploadr.app.tags.Tag(tag.getValue()));
		Collections.sort(tags);
		return true;
	}

	public List<org.scohen.juploadr.app.tags.Tag> getTags() {
		return tags;
	}
}
