...
public class Message {
	 ...
	 * 
	 * @param accList
	 *            an email address list for the "Cc" field.
	 */
	 ...
	 * 
	 * @return an <code>Iterator</code> object of the message "Bcc" address
	 *         list.
	 */
	 ...
	 * 
	 * @param abccList
	 *            an email address list for the "Bcc" field.
	 */
	 ...
	 * 
	 * @param attachList
	 *            the given attachment list, whose elements are the abosolute
		...
		while (iter.hasNext()) {
			...
			if (inner_iter != null) {
				while (inner_iter.hasNext()) {
					hasDuplicated = filename.equals((inner_iter.next())); // bd
					if (hasDuplicated) // bd
						break;
				}
			}
