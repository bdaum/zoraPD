...
/**
 * The <code>Desktop</code> class provides several methods to interact with the
 * system applications and facilities. It cannot be instantiated.
 * <p>
...
public class Desktop {
	 ...
	 *             if the given file is not a valid file, or is not readable.
	 */
	 ...
	 *            the given file.
	 * @throws DesktopException
	 *             if the given file is not valid, or the given file is not
	 *             printable, or the given file fails to be printed.
	 */
	 ...
	 *            the given URL.
	 * @throws DesktopException
	 *             if the given url is null, or the system default browser is
	 *             not found, or the system browser fails to be launched.
	 */
	 ...
	 *            the given URL.
	 * @param target
	 *            the given name of a target browser window.
	 * @throws DesktopException
	 *             if the given url is null, or the system default browser is
	 *             not found, or it's found but fails to be launched.
	 */
	 ...
	 *
	 * @throws DesktopException
	 *             if the system default mailer was not found, or it fails to be
	 *             launched.
	 */
	...
	/**
	 * Launches the message compose window of the default mailer, and fills in
	 * the message fields with the field values of the given <code>Message
	 * </code> object.
	 *
	 * @param msg
	 *            the constructed <code>Message</code> object.
	 * @throws DesktopException
	 *             if the given message object is null, or the system default
	 *             mailer was not found, or it fails to be launched.
	 */
	public static void mail(Message msg) throws DesktopException {
		...
		try {
			if (mailerService != null) // bd
				...
				throw new DesktopException("No mailer service");// bd
		} catch (LaunchFailedException e) {
			throw new DesktopException(e.getMessage());
		}
	}
