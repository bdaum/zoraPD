...
public class DocumentIterator implements IDocumentIterator{
	...
	private Iterator<LeafReaderContext> leavesIterator;
	private PostingsEnum termDocsEnum;
	private Bits liveDocs;
	private LeafReader atomicReader;
	...
	public int next() throws IOException {
		if (leavesIterator != null) {
			while (true) {
				...
				termDocsEnum = atomicReader.postings(term);
