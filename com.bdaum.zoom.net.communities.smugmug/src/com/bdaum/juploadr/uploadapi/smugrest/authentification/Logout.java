...
public class Logout extends SmugmugMethod {
	...
	public SortedMap<String, String> getParams() {
		...
		map.put("method", "smugmug.logout"); //$NON-NLS-1$ //$NON-NLS-2$
		map.put("SessionID", session.getSessionId()); //$NON-NLS-1$
		return map;
	}
