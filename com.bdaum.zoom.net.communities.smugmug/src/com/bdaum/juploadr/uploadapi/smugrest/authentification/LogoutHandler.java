...
public class LogoutHandler extends DefaultSmugmugHandler {

    public LogoutHandler(Object parent) {
        super(parent);
    }
     ...
     * (non-Javadoc)
     * 
     * @see org.scohen.juploadr.uploadapi.rest.DefaultFlickrHandler#startElement(java.lang.String,
