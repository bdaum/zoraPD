...
public class RgbImpl extends Rgb_typeImpl implements Rgb {

	static final long serialVersionUID = -2973347153L;
	...
	public static void attachInstrumentation(Properties properties,
			Aspect aspect) {
		attachInstrumentation(_instrumentation, RgbImpl.class, properties,
				aspect);
	}
