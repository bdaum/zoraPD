...
public class GhostImpl extends Ghost_typeImpl implements Ghost {

	static final long serialVersionUID = -1121240650L;
	 ...
	 */
	public GhostImpl(String name, String uri, String volume) {
		super(name, uri, volume);
	...
	public static void attachInstrumentation(Properties properties,
			Aspect aspect) {
		attachInstrumentation(_instrumentation, GhostImpl.class, properties,
				aspect);
	}
