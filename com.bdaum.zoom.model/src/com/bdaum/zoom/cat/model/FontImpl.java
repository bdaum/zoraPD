...
public class FontImpl extends Font_typeImpl implements Font {

	static final long serialVersionUID = -1050877583L;
	 ...
	 */
	public FontImpl(int size, int style, int weight, int variant, Rgb_type color) {
		super(size, style, weight, variant, color);
	...
	public static void attachInstrumentation(Properties properties,
			Aspect aspect) {
		attachInstrumentation(_instrumentation, FontImpl.class, properties,
				aspect);
	}
