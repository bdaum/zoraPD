...
public class CriterionImpl extends Criterion_typeImpl implements Criterion {

	static final long serialVersionUID = -2070819208L;
	...
	public static void attachInstrumentation(Properties properties,
			Aspect aspect) {
		attachInstrumentation(_instrumentation, CriterionImpl.class,
				properties, aspect);
	}
