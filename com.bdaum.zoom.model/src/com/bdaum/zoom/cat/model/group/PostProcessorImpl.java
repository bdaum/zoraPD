...
import java.util.*;
import com.bdaum.zoom.cat.model.PostProcessor_typeImpl;
...
public class PostProcessorImpl extends PostProcessor_typeImpl implements
		PostProcessor {

	static final long serialVersionUID = 405886761L;
	...
	public static void attachInstrumentation(Properties properties,
			Aspect aspect) {
		attachInstrumentation(_instrumentation, PostProcessorImpl.class,
				properties, aspect);
	}
