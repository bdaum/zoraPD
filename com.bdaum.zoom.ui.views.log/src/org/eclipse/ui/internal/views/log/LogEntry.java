...
public class LogEntry extends AbstractEntry {
	...
	/**
	 * Returns the {@link LogSession} for this entry or the parent
	 * {@link LogSession} iff:
	 * <ul>
	 * <li>The session is <code>null</code> for this entry</li>
	 * <li>The parent of this entry is not <code>null</code> and is a
	 * {@link LogEntry}</li>
	 * </ul>
	 * 
	...
	/**
	 * Sets the {@link LogSession} for this entry. No validation is done on the
	 * new session.
	 * 
	 * @param session
	 *            the session to set.
	...
	/**
	 * Returns the message for this entry or <code>null</code> if there is no
	 * message
	 * 
	...
	/**
	 * Returns the stack trace for this entry or <code>null</code> if there is
	 * no stack trace
	 * 
	...
	/**
	 * Returns the date for this entry or the epoch if the current date value is
	 * <code>null</code>
	 * 
	...
	/**
	 * Returns the human-readable text representation of the integer severity
	 * value or '<code>?</code>' if the severity is unknown.
	 * 
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.ui.internal.views.log.AbstractEntry#getLabel(java.lang.
	 * Object)
	 */
	...
	/**
	 * Sets the stack to the given stack value. No validation is performed on
	 * the new value.
	 * 
	 * @param stack
	 */
	...
	/**
	 * Sets the message to the given message value. No validation is performed
	 * on the new value
	 * 
	 * @param message
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.ui.internal.views.log.AbstractEntry#write(java.io.
	 * PrintWriter)
	 */
