...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "com.bdaum.zoom.ui.views.log"; //"org.eclipse.ui.views.log"; //$NON-NLS-1$
	...
	private static ImageDescriptor createImageDescriptor(String id) {
