...
public class SpinnerFieldEditor extends FieldEditor {
	 ...
	 * @since 2.0
	 */
	public SpinnerFieldEditor(String name, String labelText, int width,
	...
	protected boolean checkState() {
		...
		boolean result = spinner != null && doCheckState();
	...
	public int getIntValue() {
		return (spinner != null) ? spinner.getSelection()
	 ...
	 */
	public Spinner getControl(Composite parent) {
		if (spinner == null) {
