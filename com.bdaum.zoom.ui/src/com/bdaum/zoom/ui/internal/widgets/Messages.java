...
public class Messages extends NLS {
	...
	public static String CheckedText_add_to_dict;
	...
	public static String TextField_add_to_dict;
	public static String TextField_copy;
	public static String TextField_cut;
	public static String TextField_paste;
	...
	public static String TextWithVariableGroup_cat_name;
	public static String TextWithVariableGroup_cat_owner;
	public static String TextWithVariableGroup_current_date;
	public static String TextWithVariableGroup_number_of_images;
	public static String TextWithVariableGroup_page_number;
	public static String TextWithVariableGroup_current_computer_user;
	public static String TextWithVariableGroup_collection_name;
	public static String TextWithVariableGroup_title;
	public static String TextWithVariableGroup_page_item_no;
	public static String TextWithVariableGroup_file_format;
	public static String TextWithVariableGroup_file_name;
	public static String TextWithVariableGroup_creation_date;
	public static String TextWithVariableGroup_sequence_number;
	public static String TextWithVariableGroup_size;
	public static String TextWithVariableGroup_description;
