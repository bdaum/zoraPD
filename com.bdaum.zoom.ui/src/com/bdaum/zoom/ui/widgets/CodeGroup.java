...
public class CodeGroup extends Composite {
	...
	public CodeGroup(final Composite parent, int style, final CodeParser parser) {
		super(parent, style);
		this.parser = parser;
		...
		button.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				CodesDialog dialog = new CodesDialog(parent.getShell(), parser,
	...
	public void setBounds(Rectangle rect) {
		if (!withLayout) {
			...
			button.setBounds(rect.width - rect.height, 0, rect.height,
					rect.height);
		}
