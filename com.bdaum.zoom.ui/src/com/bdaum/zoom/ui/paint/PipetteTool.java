...
public class PipetteTool extends ContinuousPaintSession implements PaintTool {
	 ...
	 * @param paintExample
	 */
	public PipetteTool(ToolSettings toolSettings, PaintExample paintExample) {
		super(paintExample);
		set(toolSettings);
	}
	...
	public void beginSession() { // bd
		super.beginSession();
		getPaintSurface().setStatusMessage(PaintExample.getResourceString("session.Pipette.message")); //$NON-NLS-1$
	}
