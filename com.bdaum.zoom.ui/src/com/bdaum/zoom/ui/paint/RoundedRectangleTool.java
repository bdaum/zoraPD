...
public class RoundedRectangleTool extends DragPaintSession implements PaintTool {
	 ...
	 * @param paintExample
	 */
	public RoundedRectangleTool(ToolSettings toolSettings, PaintExample paintExample) {
		super(paintExample);
		set(toolSettings);
	}
	...
	public String getDisplayName() {
		return PaintExample.getResourceString("tool.RoundedRectangle.label"); //$NON-NLS-1$
	}
