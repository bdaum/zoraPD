...
public class EllipseTool extends DragPaintSession implements PaintTool {
	 ...
	 * @param paintExample
	 */
	public EllipseTool(ToolSettings toolSettings, PaintExample paintExample) {
		super(paintExample);
		set(toolSettings);
	}
	...
	public String getDisplayName() {
		return PaintExample.getResourceString("tool.Ellipse.label"); //$NON-NLS-1$
	}
	...
	protected Figure createFigure(Point a, Point b) {
		...
		if (settings.commonFillType != ToolSettings.ftNone)
			container.add(new SolidEllipseFigure(settings.commonBackgroundColor, settings.pencilOpacity, a.x, a.y, b.x, b.y));
