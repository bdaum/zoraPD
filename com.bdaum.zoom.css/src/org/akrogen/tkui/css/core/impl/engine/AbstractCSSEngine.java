 ...
 * @author bdaum - fixed memory leak (bd1)
 */
...
//				getElementsContext().put(getNativeWidget(element),  // bd1
//						elementContext);  // bd1
				cacheElementContext(getNativeWidget(element), elementContext);
			}
	...
	protected void cacheElementContext(Object nativeWidget, // bd1
		...
		getElementsContext().put(nativeWidget,  // bd1
				elementContext);  // bd1
	} // bd1
