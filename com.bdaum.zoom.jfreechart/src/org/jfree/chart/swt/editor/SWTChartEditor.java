 ...
 *  7-Feb-2017 : Make editor child of given parent shell to aoid freeze (bd)
 *
 */
...
public class SWTChartEditor implements ChartEditor {
	...
	public SWTChartEditor(Display display, JFreeChart chart2edit) {
		Shell activeShell = display.getActiveShell(); // bd
		if (activeShell != null) // bd
			this.shell = new Shell(activeShell, SWT.DIALOG_TRIM); // bd
		else // bd
