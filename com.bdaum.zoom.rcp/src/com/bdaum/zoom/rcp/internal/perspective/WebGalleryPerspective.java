...
public class WebGalleryPerspective extends AbstractPerspective {

	private static final String WEBGALLERY_FOLDER = "com.bdaum.zoom.ui.views.WebGalleryFolder"; //$NON-NLS-1$
	public static final String ID = "com.bdaum.zoom.WebGalleryPerspective"; //$NON-NLS-1$

	public void createInitialLayout(IPageLayout layout) {
		super.createInitialLayout(layout);
		IFolderLayout folder = layout.createFolder(WEBGALLERY_FOLDER,
				IPageLayout.RIGHT, 0.9f, IPageLayout.ID_EDITOR_AREA);
		fillMainFolder(folder, WebGalleryView.ID);
		createCatalogFolder(layout, IPageLayout.LEFT, 0.19f, WebGalleryView.ID);
