...
public class PreferenceConstants {
	...
	public static final String AUTOSTART = "com.bdaum.zoom.webserver.autostart"; //$NON-NLS-1$
	public static final String WEBMETADATA = "com.bdaum.zoom.webserver.webmetadata"; //$NON-NLS-1$
	public static final String IMAGEPATH = "com.bdaum.zoom.webserver.imagepath"; //$NON-NLS-1$
	public static final String EXHIBITIONPATH = "com.bdaum.zoom.webserver.exhibitionpath"; //$NON-NLS-1$
	public static final String GALLERYPATH = "com.bdaum.zoom.webserver.gallerypath"; //$NON-NLS-1$
	public static final String THUMBNAILSPERPAGE = "com.bdaum.zoom.webserver.thumbnailsPerPage"; //$NON-NLS-1$
	public static final String PRIVACY = "com.bdaum.zoom.webserver.privacy"; //$NON-NLS-1$
	public static final String FORMATS = "com.bdaum.zoom.webserver.formats"; //$NON-NLS-1$
	public static final String IMAGESTITLE = "com.bdaum.zoom.webserver.imagestitle"; //$NON-NLS-1$
	public static final String EXHIBITIONSTITLE = "com.bdaum.zoom.webserver.exhibitionstitle"; //$NON-NLS-1$
	public static final String GALLERIESTITLE = "com.bdaum.zoom.webserver.galleriestitle"; //$NON-NLS-1$
	public static final String IMAGES = "com.bdaum.zoom.webserver.images"; //$NON-NLS-1$
	public static final String EXHIBITIONS = "com.bdaum.zoom.webserver.exhibitions"; //$NON-NLS-1$
	...
	public static final String TRANSFERFOLDER = "com.bdaum.zoom.webserver.transferFolder"; //$NON-NLS-1$
...
//	public static final String[] HTMLTYPES = new String[] { INDEX, LIGHTBOX, VIEW, VIDEO, SLIDESHOW, LOGIN, UPLOADS, STATUS, ERROR, HELP };
	...
	public static final int CATEGERIES = 1 << 1;
	public static final int DIRECTORIES = 1 << 2;
	public static final int IMPORTS = 1 << 3;
	public static final int LOCATIONS = 1 << 4;
	public static final int MEDIA = 1 << 5;
	public static final int PERSONS = 1 << 6;
